...
describe('SelectionHandler - isAddToCurrentSelect', () => {
  ...
  it('should return true on ctrlKey when allowModifierSelect and not Mac (sh-add-to-current-002)', () => {
    ...
    const handler = createSelectionHandler(ctx.container, ctx.mockSelectionProxy, ctx.mockOnClickAnnotation, optionsWithModifier, ctx.mockStoreProxy);
  ...
  it('should return false when allowModifierSelect is false (sh-add-to-current-004)', () => {
    ...
    const handler = createSelectionHandler(ctx.container, ctx.mockSelectionProxy, ctx.mockOnClickAnnotation, optionsWithoutModifier, ctx.mockStoreProxy);
