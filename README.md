...
See also: [React](packages/text-annotator-react) | [TEI/XML Extension](packages/extension-tei) | [Recogito PDF Annotator](https://github.com/recogito/pdf-annotator-js) 
